...
export const metadata: Metadata = {
  ...
  alternates: { canonical: canonical("/case-studies/mn-dastur-bim") },
  openGraph: {
    url: canonical("/case-studies/mn-dastur-bim"),
    title: `M. N. Dastur — BIM Transformation at Scale | ${NAME}`,
    description:
      "Converted 50+ years of classical engineering to BIM-based virtual engineering across 32 disciplines; overcame resistance and delivered collaborative 3D and waste reduction.",
  ...
  twitter: {
    ...
    title: `M. N. Dastur — BIM Transformation at Scale | ${NAME}`,
    description:
      "Enterprise BIM rollout: standards, collaboration, change management, and data-centric handover.",
    images: [OG],
  },
};
